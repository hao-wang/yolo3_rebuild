"""
Adopted from https://github.com/mukopikmin/bounding-box-augmentation/blob/master/util/sequence.py,
some parameters changed to fit the current problem.
"""
import imgaug as ia
...
def get():
    ...
    return iaa.Sequential(
        [
            ...
            # crop images by -15% to 30% of their height/width
            ...
            sometimes(iaa.Affine(
                ...
                # translate by -40/-10 to +40/+10 percent (per axis)
                translate_percent={'x': (-0.4, 0.4), 'y': (-0.1, 0.1)},
                rotate=(-10, 10),  # rotate by -10 to +1- degrees
